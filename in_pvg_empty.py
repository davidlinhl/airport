...
for gps_file in all_gps_files:
    if "{}in_PVG_empty.txt".format(gps_file.rstrip("gps.txt")) in os.listdir(all_pvg_empty_path):
        continue
    ...
    out_file_path=os.path.join(all_pvg_empty_path,"{}in_PVG_empty.txt".format(gps_file.rstrip("gps.txt")))
